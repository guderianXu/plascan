...
用法：
    python scripts/workflows/extract_features.py --algo disk   --images /path/to/images/*.jpg --output /path/to/output
    python scripts/workflows/extract_features.py --algo aliked --images /path/to/images/*.jpg --output /path/to/output
