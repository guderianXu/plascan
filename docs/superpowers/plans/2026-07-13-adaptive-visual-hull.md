...
4. Retry an over-fragmented strict result without depth carving, then reject an inconsistent silhouette-only result.
5. Record the actual algorithm/fallback and quality-gate diagnostics in workflow JSON.
