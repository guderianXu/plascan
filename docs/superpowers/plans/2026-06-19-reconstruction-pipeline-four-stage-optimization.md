...
Remaining evidence gap before claiming final release completion: the remote GitHub Actions/tag/Release state is not proven
in this plan file. Do not mark the overall release complete from the focused tests alone.
