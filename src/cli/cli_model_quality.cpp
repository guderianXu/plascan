...
QString token(const std::string &value)
{
...
int main(int argc, char *argv[])
{
    ...
    const QString scene = token(scene_type);
    ...
    const QString split = token(validation_split);
    ...
    writeJson(result.ok ? stdout : stderr, resultJson(result));
