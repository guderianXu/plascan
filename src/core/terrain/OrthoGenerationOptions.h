...
namespace xjw
{
    ...
    struct OrthoGenerationOptions
    {
        ...
        TerrainComputeBackend computeBackend = TerrainComputeBackend::Auto;
        int computeDeviceIndex = -1;

        static bool fromJson(const QJsonObject& settings, OrthoGenerationOptions* options, QString* errorMsg = nullptr);
