...
namespace xjw
{
    namespace mvs
    {
        ...
        public:
            ...
            virtual bool
            estimate(const PatchMatchBackendRequest& request, DepthLevelResult& result, std::string* errorMessage) = 0;
        };
        ...
        struct DepthPyramidRequest
        {
            ...
            std::function<bool(const DepthLevelSummary&, std::string*)> firstLevelCompletionGate;
        };
