...
bool run_recovered_patchmatch_undistort_cuda_impl(
    const PatchMatchUndistortInput& input,
...
bool run_recovered_patchmatch_wta_cuda_impl(
    ...
    std::string& error);
bool run_recovered_patchmatch_wta_cuda_source_impl(
    PatchMatchWtaInput& input,
    PatchMatchWtaOutput& output,
    std::string& error);
bool run_recovered_patchmatch_copy_inlier_masks_cuda_impl(
    ...
    std::string& error);
bool run_recovered_patchmatch_copy_inlier_masks_cuda_source_impl(
    PatchMatchCopyInlierMasksInput& input,
    PatchMatchCopyInlierMasksOutput& output,
    std::string& error);
...
bool run_recovered_patchmatch_coarse_to_precise_cuda_impl(
    ...
    PatchMatchCandidateOutput& output,
    std::string& error);
bool run_recovered_patchmatch_coarse_to_precise_cuda_source_impl(
    PatchMatchCoarseToPreciseInput& input,
    PatchMatchCandidateOutput& output,
    std::string& error);
...
bool run_recovered_patchmatch_bilateral_u8_cuda_impl(
    ...
    std::string& error);
bool run_recovered_patchmatch_bilateral_u8_cuda_source_impl(
    const PatchMatchBilateralU8Input& input,
    PatchMatchBilateralU8Output& output,
    std::string& error);
bool run_recovered_patchmatch_bilateral_u16_cuda_impl(
    const PatchMatchBilateralU16Input& input,
    PatchMatchBilateralU8Output& output, std::string& error);
bool run_recovered_patchmatch_bilateral_u16_cuda_source_impl(
    const PatchMatchBilateralU16Input& input,
    PatchMatchBilateralU8Output& output, std::string& error);
bool run_recovered_patchmatch_bilateral_f32_cuda_impl(
    const PatchMatchBilateralF32Input& input,
    PatchMatchBilateralU8Output& output, std::string& error);
bool run_recovered_patchmatch_bilateral_f32_cuda_source_impl(
    const PatchMatchBilateralF32Input& input,
    PatchMatchBilateralU8Output& output, std::string& error);
bool run_recovered_patchmatch_filter_check_cost_cuda_impl(
    ...
    std::string& error);
bool run_recovered_patchmatch_filter_check_cost_cuda_source_impl(
    const PatchMatchFilterCheckCostInput& input,
    PatchMatchFilterCheckCostOutput& output,
    std::string& error);
bool run_recovered_patchmatch_filter_check_neighbours_cuda_impl(
    ...
    std::string& error);
bool run_recovered_patchmatch_filter_check_neighbours_cuda_source_impl(
    const PatchMatchFilterCheckNeighboursInput& input,
    PatchMatchFilterCheckNeighboursOutput& output,
    std::string& error);
bool run_recovered_patchmatch_filter_clear_depth_cuda_impl(
    ...
    std::string& error);
bool run_recovered_patchmatch_filter_clear_depth_cuda_source_impl(
    const PatchMatchFilterClearDepthInput& input,
    PatchMatchFilterClearDepthOutput& output,
    std::string& error);
bool run_recovered_patchmatch_filter_normals_cuda_impl(
    ...
    std::string& error);
bool run_recovered_patchmatch_filter_normals_cuda_source_impl(
    const PatchMatchFilterNormalsInput& input,
    PatchMatchFilterNormalsOutput& output,
    std::string& error);
bool run_recovered_patchmatch_rotate_normals_cuda_impl(
    const PatchMatchRotateNormalsInput& input,
    PatchMatchRotateNormalsOutput& output,
    std::string& error);
bool run_recovered_patchmatch_rotate_normals_cuda_source_impl(
    const PatchMatchRotateNormalsInput& input,
    PatchMatchRotateNormalsOutput& output,
    std::string& error);
bool run_recovered_patchmatch_average_costs_cuda_impl(
    const PatchMatchAverageCostsInput& input,
    PatchMatchAverageCostsOutput& output,
    std::string& error);
bool run_recovered_patchmatch_average_costs_cuda_source_impl(
    const PatchMatchAverageCostsInput& input,
    PatchMatchAverageCostsOutput& output,
    std::string& error);
bool run_recovered_patchmatch_filter_speckles_edges_cuda_impl(
    ...
    std::string& error);
bool run_recovered_patchmatch_filter_speckles_edges_cuda_source_impl(
    const PatchMatchFilterSpecklesEdgesInput& input,
    PatchMatchFilterSpecklesEdgesOutput& output,
    std::string& error);
...
bool run_recovered_depth_voting_finalize_cuda_impl(
    ...
    std::string& error);
bool run_recovered_depth_voting_finalize_cuda_source_impl(
    const DepthVotingFinalizeInput& input,
    DepthVotingFinalizeOutput& output,
    std::string& error);
...
bool run_recovered_depth_radius_estimate_cuda_impl(
    ...
    std::string& error);
bool run_recovered_depth_radius_estimate_cuda_source_impl(
    const DepthRadiusEstimateInput& input,
    std::vector<float>& radius_output,
    std::string& error);
bool run_recovered_depth_radius_estimate_cuda_ptx_oracle_impl(
    const DepthRadiusEstimateInput& input,
    std::vector<float>& radius_output,
    std::string& error);
bool run_recovered_depth_neighbor_votes_cuda_impl(
    ...
    std::string& error);
bool run_recovered_depth_neighbor_votes_cuda_source_impl(
    const DepthNeighborVotesInput& input,
    DepthNeighborVotesOutput& output,
    std::string& error);
bool run_recovered_depth_neighbor_votes_cuda_ptx_oracle_impl(
    const DepthNeighborVotesInput& input,
    DepthNeighborVotesOutput& output,
    std::string& error);
bool run_recovered_depth_neighbor_occlusion_votes_cuda_impl(
    ...
    std::string& error);
bool run_recovered_depth_neighbor_occlusion_votes_cuda_source_impl(
    const DepthNeighborOcclusionVotesInput& input,
    DepthNeighborOcclusionVotesOutput& output,
    std::string& error);
...
bool run_recovered_patchmatch_undistort_u8_cuda(
    ...
    std::string& error) {
#ifdef METMODEL_HAS_CUDA
    return run_recovered_patchmatch_undistort_u8_cuda_impl(
...
bool run_recovered_patchmatch_undistort_u8_cuda_source(
    const PatchMatchUndistortU8Input& input,
    RecoveredPatchMatchImageU8& output,
    std::string& error) {
    ...
    return run_recovered_patchmatch_undistort_u8_cuda_impl(
        input, output, error, true);
#else
    (void)input; output = {}; error = "CUDA support is unavailable"; return false;
#endif
}

bool run_recovered_patchmatch_undistort_u8_cuda_ptx_oracle(
    const PatchMatchUndistortU8Input& input,
    RecoveredPatchMatchImageU8& output,
    std::string& error) {
#if defined(METMODEL_HAS_CUDA)
...
bool run_recovered_patchmatch_undistort_cuda_source(
    const PatchMatchUndistortInput& input,
    PatchMatchUndistortOutput& output,
    std::string& error) {
#if defined(METMODEL_HAS_CUDA)
    return run_recovered_patchmatch_undistort_cuda_impl(
        input, output, error, true);
#else
    (void)input; output = {}; error = "CUDA support is unavailable"; return false;
#endif
...
bool run_recovered_patchmatch_undistort_cuda_ptx_oracle(
    const PatchMatchUndistortInput& input,
    PatchMatchUndistortOutput& output,
    std::string& error) {
#if defined(METMODEL_HAS_CUDA)
...
bool run_recovered_depth_radius_estimate_cuda_source(
    const DepthRadiusEstimateInput& input,
    std::vector<float>& radius_output,
    std::string& error) {
#ifdef METMODEL_HAS_CUDA
    return run_recovered_depth_radius_estimate_cuda_source_impl(
        input, radius_output, error);
#else
    (void)input;
    (void)radius_output;
...
bool run_recovered_depth_radius_estimate_cuda_ptx_oracle(
    const DepthRadiusEstimateInput& input,
    std::vector<float>& radius_output,
    std::string& error) {
#ifdef METMODEL_HAS_CUDA
    return run_recovered_depth_radius_estimate_cuda_ptx_oracle_impl(
        input, radius_output, error);
#else
    (void)input;
    (void)radius_output;
...
bool run_recovered_depth_neighbor_votes_cuda_source(
    const DepthNeighborVotesInput& input,
    DepthNeighborVotesOutput& output,
    std::string& error) {
#ifdef METMODEL_HAS_CUDA
    return run_recovered_depth_neighbor_votes_cuda_source_impl(
        input, output, error);
#else
    (void)input;
    (void)output;
...
bool run_recovered_depth_neighbor_votes_cuda_ptx_oracle(
    const DepthNeighborVotesInput& input,
    DepthNeighborVotesOutput& output,
    std::string& error) {
#ifdef METMODEL_HAS_CUDA
    return run_recovered_depth_neighbor_votes_cuda_ptx_oracle_impl(
        input, output, error);
#else
    (void)input;
    (void)output;
...
bool run_recovered_depth_neighbor_occlusion_votes_cuda_source(
    const DepthNeighborOcclusionVotesInput& input,
    DepthNeighborOcclusionVotesOutput& output,
    std::string& error) {
#ifdef METMODEL_HAS_CUDA
    return run_recovered_depth_neighbor_occlusion_votes_cuda_source_impl(
        input, output, error);
#else
    (void)input;
    (void)output;
...
bool run_recovered_depth_neighbor_occlusion_votes_cuda_ptx_oracle(
    const DepthNeighborOcclusionVotesInput& input,
    DepthNeighborOcclusionVotesOutput& output,
    std::string& error) {
#ifdef METMODEL_HAS_CUDA
    return run_recovered_depth_neighbor_occlusion_votes_cuda_ptx_oracle_impl(
        input, output, error);
#else
    (void)input;
    (void)output;
...
bool run_recovered_depth_voting_finalize_cuda_source(
    const DepthVotingFinalizeInput& input,
    DepthVotingFinalizeOutput& output,
    std::string& error) {
#ifdef METMODEL_HAS_CUDA
    return run_recovered_depth_voting_finalize_cuda_source_impl(
        input, output, error);
#else
    (void)input;
    (void)output;
...
bool run_recovered_patchmatch_refinement_cuda(
    ...
    const bool source_specialization = replay_safe_input.camera.type == 0U &&
    ...
    return run_recovered_patchmatch_refinement_cuda_impl(
        replay_safe_input, output, error, true);
#else
    (void)input;
    (void)output;
...
bool run_recovered_patchmatch_refinement_cuda_movable(
    ...
    std::string& error) {
#ifdef METMODEL_HAS_CUDA
    const bool source_specialization = input.camera.type == 0U &&
...
bool run_recovered_patchmatch_refinement_cuda_source(
    const PatchMatchRefinementInput& input,
    PatchMatchCandidateOutput& output,
    std::string& error) {
#ifdef METMODEL_HAS_CUDA
...
bool run_recovered_patchmatch_refinement_cuda_ptx_oracle(
    const PatchMatchRefinementInput& input,
    PatchMatchCandidateOutput& output,
    std::string& error) {
#ifdef METMODEL_HAS_CUDA
    PatchMatchRefinementInput replay_safe_input = input;
    return run_recovered_patchmatch_refinement_cuda_impl(
        replay_safe_input, output, error, false);
#else
    (void)input; (void)output;
    error = "recovered CUDA PatchMatch backend was not compiled";
    return false;
...
bool run_recovered_patchmatch_final_refinement_cuda(
    ...
    const bool supported_camera = replay_safe_input.camera.type == 0U ||
        replay_safe_input.camera.type == 2U ||
        replay_safe_input.camera.type == 3U ||
        replay_safe_input.camera.type == 4U ||
        replay_safe_input.camera.type == 8U ||
        replay_safe_input.camera.type == 9U ||
    ...
    return run_recovered_patchmatch_final_refinement_cuda_impl(
        replay_safe_input, output, nullptr, error, true);
#else
    (void)input;
    (void)output;
    error = "recovered CUDA PatchMatch backend was not compiled";
...
bool run_recovered_patchmatch_final_refinement_cuda_source(
    const PatchMatchFinalRefinementInput& input,
    PatchMatchCandidateOutput& output,
    std::string& error) {
#ifdef METMODEL_HAS_CUDA
    const bool supported_camera = input.camera.type == 0U ||
        input.camera.type == 2U || input.camera.type == 3U ||
        input.camera.type == 4U || input.camera.type == 8U ||
        input.camera.type == 9U || input.camera.type == 10U;
...
bool run_recovered_patchmatch_final_refinement_cuda_ptx_oracle(
    const PatchMatchFinalRefinementInput& input,
    PatchMatchCandidateOutput& output,
    std::string& error) {
#ifdef METMODEL_HAS_CUDA
    PatchMatchFinalRefinementInput replay_safe_input = input;
    return run_recovered_patchmatch_final_refinement_cuda_impl(
        replay_safe_input, output, nullptr, error, false);
#else
    (void)input;
    (void)output;
    error = "recovered CUDA PatchMatch backend was not compiled";
...
bool run_recovered_patchmatch_final_refinement_state_cuda_movable(
    ...
    return run_recovered_patchmatch_final_refinement_cuda_impl(
        input, output.candidates, &output.cost, error, true);
#else
    (void)input;
    (void)output;
    error = "recovered CUDA PatchMatch backend was not compiled";
...
bool run_recovered_patchmatch_wta_cuda_source(
    const PatchMatchWtaInput& input,
    PatchMatchWtaOutput& output,
    std::string& error) {
#ifdef METMODEL_HAS_CUDA
    PatchMatchWtaInput replay_safe_input = input;
    return run_recovered_patchmatch_wta_cuda_source_impl(
        replay_safe_input, output, error);
#else
    (void)input;
    (void)output;
...
bool run_recovered_patchmatch_wta_cuda_source_movable(
    PatchMatchWtaInput&& input,
    PatchMatchWtaOutput& output,
    std::string& error) {
#ifdef METMODEL_HAS_CUDA
...
bool run_recovered_patchmatch_copy_inlier_masks_cuda_source(
    const PatchMatchCopyInlierMasksInput& input,
    PatchMatchCopyInlierMasksOutput& output,
    std::string& error) {
#ifdef METMODEL_HAS_CUDA
    PatchMatchCopyInlierMasksInput replay_safe_input = input;
    return run_recovered_patchmatch_copy_inlier_masks_cuda_source_impl(
        replay_safe_input, output, error);
#else
    (void)input;
    (void)output;
...
bool run_recovered_patchmatch_copy_inlier_masks_cuda_source_movable(
    PatchMatchCopyInlierMasksInput&& input,
    PatchMatchCopyInlierMasksOutput& output,
    std::string& error) {
#ifdef METMODEL_HAS_CUDA
...
bool run_recovered_patchmatch_propagation_cuda(
    ...
    const bool source_camera =
        (replay_safe_input.camera.type == 0U ||
         replay_safe_input.camera.type == 2U ||
         replay_safe_input.camera.type == 3U ||
         replay_safe_input.camera.type == 4U ||
         replay_safe_input.camera.type == 8U ||
...
#ifdef METMODEL_HAS_CUDA
    const bool source_camera =
        (input.camera.type == 0U || input.camera.type == 2U ||
         input.camera.type == 3U || input.camera.type == 4U ||
         input.camera.type == 8U || input.camera.type == 9U ||
...
bool run_recovered_patchmatch_propagation_cuda_source(
    const PatchMatchPropagationInput& input,
    PatchMatchCandidateOutput& output,
    std::string& error) {
#ifdef METMODEL_HAS_CUDA
...
bool run_recovered_patchmatch_propagation_cuda_ptx_oracle(
    const PatchMatchPropagationInput& input,
    PatchMatchCandidateOutput& output,
    std::string& error) {
#ifdef METMODEL_HAS_CUDA
...
bool run_recovered_patchmatch_coarse_to_precise_cuda_source(
    const PatchMatchCoarseToPreciseInput& input,
    PatchMatchCandidateOutput& output,
    std::string& error) {
#ifdef METMODEL_HAS_CUDA
    PatchMatchCoarseToPreciseInput replay_safe_input = input;
    return run_recovered_patchmatch_coarse_to_precise_cuda_source_impl(
        replay_safe_input, output, error);
#else
    (void)input;
    (void)output;
...
bool run_recovered_patchmatch_coarse_to_precise_cuda_source_movable(
    PatchMatchCoarseToPreciseInput&& input,
    PatchMatchCandidateOutput& output,
    std::string& error) {
#ifdef METMODEL_HAS_CUDA
...
bool run_recovered_patchmatch_cost_cuda_ptx_oracle(
    const PatchMatchCostInput& input,
    PatchMatchCostOutput& output,
    std::string& error) {
#ifdef METMODEL_HAS_CUDA
...
bool run_recovered_patchmatch_cost_cuda_source(
    const PatchMatchCostInput& input,
    PatchMatchCostOutput& output,
    std::string& error) {
#ifdef METMODEL_HAS_CUDA
...
bool run_recovered_patchmatch_rotate_normals_cuda(
    const PatchMatchRotateNormalsInput& input,
    PatchMatchRotateNormalsOutput& output,
    std::string& error) {
#ifdef METMODEL_HAS_CUDA
    return run_recovered_patchmatch_rotate_normals_cuda_impl(
        input, output, error);
#else
    (void)input;
    (void)output;
...
bool run_recovered_patchmatch_rotate_normals_cuda_source(
    const PatchMatchRotateNormalsInput& input,
    PatchMatchRotateNormalsOutput& output,
    std::string& error) {
#ifdef METMODEL_HAS_CUDA
    return run_recovered_patchmatch_rotate_normals_cuda_source_impl(
        input, output, error);
#else
    (void)input;
    (void)output;
...
bool run_recovered_patchmatch_average_costs_cuda(
    const PatchMatchAverageCostsInput& input,
    PatchMatchAverageCostsOutput& output,
    std::string& error) {
#ifdef METMODEL_HAS_CUDA
    return run_recovered_patchmatch_average_costs_cuda_impl(
        input, output, error);
#else
    (void)input;
    (void)output;
...
bool run_recovered_patchmatch_average_costs_cuda_source(
    const PatchMatchAverageCostsInput& input,
    PatchMatchAverageCostsOutput& output,
    std::string& error) {
#ifdef METMODEL_HAS_CUDA
    return run_recovered_patchmatch_average_costs_cuda_source_impl(
        input, output, error);
#else
    (void)input;
    (void)output;
...
bool run_recovered_patchmatch_bilateral_u8_cuda_source(
    const PatchMatchBilateralU8Input& input,
    PatchMatchBilateralU8Output& output,
    std::string& error) {
#ifdef METMODEL_HAS_CUDA
    return run_recovered_patchmatch_bilateral_u8_cuda_source_impl(
        input, output, error);
#else
    (void)input;
    (void)output;
...
bool run_recovered_patchmatch_bilateral_u16_cuda(
    const PatchMatchBilateralU16Input& input,
    PatchMatchBilateralU8Output& output, std::string& error) {
#ifdef METMODEL_HAS_CUDA
    return run_recovered_patchmatch_bilateral_u16_cuda_impl(
        input, output, error);
#else
    (void)input; (void)output;
    error = "recovered CUDA PatchMatch bilateral backend was not compiled";
...
bool run_recovered_patchmatch_bilateral_u16_cuda_source(
    const PatchMatchBilateralU16Input& input,
    PatchMatchBilateralU8Output& output, std::string& error) {
#ifdef METMODEL_HAS_CUDA
    return run_recovered_patchmatch_bilateral_u16_cuda_source_impl(
        input, output, error);
#else
    (void)input; (void)output;
    error = "reconstructed CUDA source PatchMatch bilateral backend was not compiled";
...
bool run_recovered_patchmatch_bilateral_f32_cuda(
    const PatchMatchBilateralF32Input& input,
    PatchMatchBilateralU8Output& output, std::string& error) {
#ifdef METMODEL_HAS_CUDA
    return run_recovered_patchmatch_bilateral_f32_cuda_impl(
        input, output, error);
#else
    (void)input; (void)output;
    error = "recovered CUDA PatchMatch bilateral backend was not compiled";
...
bool run_recovered_patchmatch_bilateral_f32_cuda_source(
    const PatchMatchBilateralF32Input& input,
    PatchMatchBilateralU8Output& output, std::string& error) {
#ifdef METMODEL_HAS_CUDA
    return run_recovered_patchmatch_bilateral_f32_cuda_source_impl(
        input, output, error);
#else
    (void)input; (void)output;
    error = "reconstructed CUDA source PatchMatch bilateral backend was not compiled";
...
bool run_recovered_patchmatch_filter_check_cost_cuda_source(
    const PatchMatchFilterCheckCostInput& input,
    PatchMatchFilterCheckCostOutput& output,
    std::string& error) {
#ifdef METMODEL_HAS_CUDA
    return run_recovered_patchmatch_filter_check_cost_cuda_source_impl(
        input, output, error);
#else
    (void)input;
    (void)output;
...
bool run_recovered_patchmatch_filter_check_neighbours_cuda_source(
    const PatchMatchFilterCheckNeighboursInput& input,
    PatchMatchFilterCheckNeighboursOutput& output,
    std::string& error) {
#ifdef METMODEL_HAS_CUDA
    return run_recovered_patchmatch_filter_check_neighbours_cuda_source_impl(
        input, output, error);
#else
    (void)input;
    (void)output;
...
bool run_recovered_patchmatch_filter_clear_depth_cuda_source(
    const PatchMatchFilterClearDepthInput& input,
    PatchMatchFilterClearDepthOutput& output,
    std::string& error) {
#ifdef METMODEL_HAS_CUDA
    return run_recovered_patchmatch_filter_clear_depth_cuda_source_impl(
        input, output, error);
#else
    (void)input;
    (void)output;
...
bool run_recovered_patchmatch_filter_normals_cuda(
    ...
    std::string& error) {
#ifdef METMODEL_HAS_CUDA
    return run_recovered_patchmatch_filter_normals_cuda_source_impl(
        input, output, error);
#else
    (void)input;
    (void)output;
...
bool run_recovered_patchmatch_filter_normals_cuda_source(
    const PatchMatchFilterNormalsInput& input,
    PatchMatchFilterNormalsOutput& output,
    std::string& error) {
#ifdef METMODEL_HAS_CUDA
...
bool run_recovered_patchmatch_filter_normals_cuda_ptx_oracle(
    const PatchMatchFilterNormalsInput& input,
    PatchMatchFilterNormalsOutput& output,
    std::string& error) {
#ifdef METMODEL_HAS_CUDA
...
bool run_recovered_patchmatch_filter_speckles_edges_cuda(
    ...
    std::string& error) {
#ifdef METMODEL_HAS_CUDA
    return run_recovered_patchmatch_filter_speckles_edges_cuda_source_impl(
        input, output, error);
#else
    (void)input;
    (void)output;
...
bool run_recovered_patchmatch_filter_speckles_edges_cuda_source(
    const PatchMatchFilterSpecklesEdgesInput& input,
    PatchMatchFilterSpecklesEdgesOutput& output,
    std::string& error) {
#ifdef METMODEL_HAS_CUDA
...
bool run_recovered_patchmatch_filter_speckles_edges_cuda_ptx_oracle(
    const PatchMatchFilterSpecklesEdgesInput& input,
    PatchMatchFilterSpecklesEdgesOutput& output,
    std::string& error) {
#ifdef METMODEL_HAS_CUDA
    ...
    try {
        ...
        if (!for_each_launch([&](std::uint32_t offset,
                ...
                const bool normal_ok =
                    run_recovered_patchmatch_filter_normals_cuda_source(
        ...
        if (!for_each_launch([&](std::uint32_t offset,
                ...
                const bool succeeded =
                    run_recovered_patchmatch_filter_speckles_edges_cuda_source(
...
bool run_recovered_patchmatch_level_boundary_cuda(
    ...
    if (!run_recovered_patchmatch_bilateral_u8_cuda_source(
