...
#pragma omp parallel for schedule(static)
        ...
        primary_bridge_reach = dilateSampleMask(
            ...
            std::clamp(
                options.auxiliaryBridgeMaximumExtensionVoxels, 1, 4));
    }
