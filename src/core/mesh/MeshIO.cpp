    ...
    namespace mesh
    {
        ...
        bool TriMesh::loadPLY(const std::string& path, TriMesh* mesh, std::string* errorMsg)
        {
            ...
            try
            {
                ...
                const int confidence_field = cloud->scalarFieldIndex("confidence");
                mesh->hasVertexConfidence = confidence_field >= 0;
        ...
        bool TriMesh::savePLY(const std::string& path, std::string* errorMsg) const
        {
            ...
            try
            {
                ...
                if (hasVertexConfidence)
                {
                    ...
                    cloud.setScalarFields({"confidence"}, std::move(confidence));
                }
