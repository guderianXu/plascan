...
namespace xjw::mesh
{
    ...
    struct DepthTsdfOptions
    {
        ...
        float validationOnlyFrameWeightMultiplier = xjw::mvs::kCoverageAuxiliaryWeightMultiplier;
        ...
        int measuredSupportMinimumGeometrySupport = 2;
        float measuredSupportMaximumInverseDepthSpread = 0.015f;
        float measuredSupportMinimumSurfaceWeightRatio = 0.10f;
        float measuredSupportMaximumAbsoluteTsdf = 0.45f;
        int measuredSupportMinimumSupportedCellCorners = 2;
        int measuredSupportMinimumComponentCells = 3;
        int measuredSupportMinimumAnchorCells = 2;
        float measuredSupportMaximumSingleVoteAbsoluteTsdf = 0.20f;
        ...
        std::size_t visibilityOccupancyMaximumHandleRepairCandidateSampleCount = 512;
    ...
    struct DepthTsdfStatistics
    {
        ...
        int geometrySourceMaskBitWidth = static_cast<int>(kDepthGeometrySourceSlotCount);
        ...
        int effectiveMeasuredSupportMinimumGeometrySupport = 0;
        float effectiveMeasuredSupportMaximumInverseDepthSpread = 0.0f;
        float effectiveMeasuredSupportMinimumSurfaceWeightRatio = 0.0f;
        float effectiveMeasuredSupportMaximumAbsoluteTsdf = 0.0f;
        int effectiveMeasuredSupportMinimumSupportedCellCorners = 0;
        int effectiveMeasuredSupportMinimumComponentCells = 0;
        int effectiveMeasuredSupportMinimumAnchorCells = 0;
        float effectiveMeasuredSupportMaximumSingleVoteAbsoluteTsdf = 0.0f;
        std::uint64_t measuredSupportConsideredSampleCount = 0;
        std::uint64_t measuredSupportRejectedObservationWeightCount = 0;
        std::uint64_t measuredSupportRejectedSourceCount = 0;
        std::uint64_t measuredSupportRejectedGeometrySupportCount = 0;
        std::uint64_t measuredSupportRejectedDepthSpreadCount = 0;
        std::uint64_t measuredSupportRejectedSurfaceWeightCount = 0;
        std::uint64_t measuredSupportRejectedAbsoluteTsdfCount = 0;
        ...
        int measuredSupportComponentCount = 0;
        int measuredSupportAcceptedComponentCount = 0;
        ...
        double measuredSupportTopologyTransactionBaselineLargestComponentFaceRatio = 0.0;
        double measuredSupportTopologyTransactionCandidateLargestComponentFaceRatio = 0.0;
        double measuredSupportTopologyTransactionBaselineExtremeAspectFaceRatio = 0.0;
        double measuredSupportTopologyTransactionCandidateExtremeAspectFaceRatio = 0.0;
        ...
        float effectiveMaximumGeometryZeroCrossingSheetSingleVoteAbsoluteTsdf = 0.0f;
        ...
        std::uint64_t visibilityOccupancySilhouetteFullPriorCandidateSampleCount = 0;
        std::uint64_t visibilityOccupancySilhouetteFullPriorSampleCount = 0;
        std::uint64_t visibilityOccupancySilhouetteFullPriorRejectedWithoutDepthSupportSampleCount = 0;
        ...
        std::uint64_t visibilityOccupancyClosingProposalDepthEmptyAtLeastTwoSampleCount = 0;
        std::uint64_t visibilityOccupancyClosingProposalDepthEmptyAtLeastThreeSampleCount = 0;
        std::uint64_t visibilityOccupancyClosingProposalDepthEmptyAtLeastFourSampleCount = 0;
        std::uint64_t visibilityOccupancyClosingProposalDepthFullSampleCount = 0;
        std::uint64_t visibilityOccupancyClosingProposalSilhouetteOutsideAtLeastTwoSampleCount = 0;
        ...
        std::uint64_t visibilityOccupancyClosingSilhouetteEmptyProtectedSampleCount = 0;
        ...
        std::uint64_t visibilityOccupancyWellComposedRepairRemainingEdgeCheckerboardCount = 0;
        std::uint64_t visibilityOccupancyWellComposedRepairRemainingVertexOccupiedDefectCount = 0;
        std::uint64_t visibilityOccupancyWellComposedRepairRemainingVertexEmptyDefectCount = 0;
    ...
    struct DepthTsdfResult
    {
        ...
        {
            const auto status = ok ? xjw::task_runtime::WorkflowStatus::Succeeded
                                   : (cancelled ? xjw::task_runtime::WorkflowStatus::Cancelled
                                                : xjw::task_runtime::WorkflowStatus::Failed);
            return {
                status,
                ok ? xjw::task_runtime::WorkflowError{}
                   : xjw::task_runtime::WorkflowError{"tsdf_failed", errorMessage.toUtf8().toStdString(), "tsdf", {}}};
        }
    };
    ...
    public:
        ...
        static bool
        isCatastrophicComponentFilterLoss(int inputFaceCount, int outputFaceCount, int minimumComponentFaces);
        ...
        static DepthTsdfBoundsResult estimateBounds(const QVector<DepthTsdfFrame>& frames,
                                                    bool useEvidenceAwareBounds = true,
                                                    bool preservePerFrameCoverageBounds = false);
        static DepthTsdfObservationSample
        sampleObservation(const DepthTsdfFrame& frame,
        ...
        static float observationEvidenceWeightMultiplier(const DepthTsdfObservationSample& observation,
                                                         const DepthTsdfOptions& options);
        static float observationInverseDepthSpreadWeightMultiplier(const DepthTsdfObservationSample& observation,
                                                                   const DepthTsdfOptions& options);
        static float observationInverseDepthSpreadSupportWeightMultiplier(const DepthTsdfObservationSample& observation,
                                                                          const DepthTsdfOptions& options);
        static float observationEvidenceSupportWeightMultiplier(const DepthTsdfObservationSample& observation,
                                                                const DepthTsdfOptions& options);
        static bool observationHasStrongAdaptiveGeometryEvidence(const DepthTsdfObservationSample& observation,
                                                                 const DepthTsdfOptions& options);
        static bool observationUsesSurfaceOnlyIntegration(const DepthTsdfObservationSample& observation,
                                                          const DepthTsdfOptions& options);
        static QVector<float> robustFrameQualityWeights(const QVector<float>& rawWeights,
                                                        ...
                                                        float* scale = nullptr);
        static int growGeometryVerifiedSingleViewSamples(const DepthTsdfLayout& layout,
        ...
        static DepthTsdfZeroCrossingStatistics analyzeZeroCrossings(const DepthTsdfLayout& layout,
                                                                    const std::vector<float>& tsdf,
                                                                    const std::vector<float>& weight,
                                                                    const std::vector<std::uint8_t>& supported);
        static DepthTsdfVisualHullCompletionStatistics completeUnsupportedSamplesWithVisualHullSignedDistance(
        ...
        evaluateVisualHullCompletionTopologyGuard(const TriMesh& baseline,
        ...
        static bool finalizeMeasuredSupportTopologyTransaction(const MeshTopologyQualityStatistics& baselineQuality,
        ...
        recoverGeometryVerifiedZeroCrossingSamples(const DepthTsdfLayout& layout,
                                                   const std::vector<float>& tsdf,
                                                   const std::vector<float>& weight,
                                                   ...
                                                   std::vector<std::uint8_t>* supported);
        static bool shouldTrimWeakBoundaryFace(int boundaryEdgeCount, int weakVertexCount);
        static bool shouldReleaseVisibilityConstrainedHole(int loopVertexCount,
        ...
        static bool shouldAcceptFinalHoleFillPatchSample(int supportingViewCount,
                                                         int conflictViewCount,
                                                         int minimumSupportingViews,
                                                         int maximumConflictViews);
        static bool shouldApplyVisibilityOccupancyCut(bool cutOk,
                                                      bool emptyCut,
                                                      std::uint64_t sampleCount,
                                                      std::uint64_t fullSampleCount,
                                                      float minimumFullFraction);
        static bool shouldAcceptQuadricSimplification(int inputFaceCount,
                                                      int outputFaceCount,
                                                      int boundaryEdgeCountBefore,
                                                      int boundaryEdgeCountAfter,
                                                      float maximumBoundaryEdgeGrowthRatio);
        static bool
        shouldAttemptVoxelFallbackSimplification(int currentFaceCount, int targetFaceCount, bool quadricReachedTarget);
        static DepthTsdfResult build(const QVector<DepthTsdfFrame>& frames, const DepthTsdfOptions& options);
        static QJsonObject statisticsToJson(const DepthTsdfResult& result);

    private:
        static DepthTsdfFrameLoadResult loadFramesSequential(const QVector<DepthFrameArtifact>& artifacts,
