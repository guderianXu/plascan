...
QString pairSourceId(PairSource source)
{
    ...
    case PairSource::CameraOverlap:
        return QStringLiteral("camera_overlap");
    case PairSource::VocabularyOverlap:
        return QStringLiteral("vocabulary_overlap");
...
QString pairSourceDisplayName(PairSource source)
{
    ...
    case PairSource::CameraOverlap:
        return QStringLiteral("相机重叠");
    case PairSource::VocabularyOverlap:
        return QStringLiteral("词汇召回");
    case PairSource::GuidedRematch:
