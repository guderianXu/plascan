...
namespace xjw
{
    ...
    public:
        ...
        bool initializeWithPose(ImageId id1, ImageId id2, const FramePinholeCamera& secondCamera);

        /// 从确定性五点子集枚举可通过全体匹配 chirality 检查的相对位姿。
        std::vector<FramePinholeCamera> enumerateFivePointPoseHypotheses(ImageId id1, ImageId id2) const;
