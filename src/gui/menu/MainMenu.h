...
public:
    ...
    void setManagedWindowActions(const QList<QAction*>& dockActions, const QList<QAction*>& toolBarActions);
    ...
    QAction* exportPortableProjectAction() const;
...
private:
    ...
    QAction* _exportPortableProjectAct{}; ///< 导出便携项目 ZIP
};
