    ...
    : QDialog(parent)
{
...

    {
        ...
        ui.applyBoxLayout->insertWidget(1, m_overwriteExistingCheck);

        m_applyHintLabel = new QLabel(this);
        m_applyHintLabel->setWordWrap(true);
        ui.applyBoxLayout->insertWidget(2, m_applyHintLabel);
        ...
        ui.solveForm->addRow(tr("求解质量:"), m_qualityCombo);
        ...
        ui.solveForm->addRow(tr("线程数:"), m_threadsSpin);

        {
            auto *page = new QWidget(m_modeStack);
