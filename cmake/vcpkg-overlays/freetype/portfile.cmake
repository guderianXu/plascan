if(NOT DEFINED ENV{VCPKG_ROOT} OR NOT EXISTS "$ENV{VCPKG_ROOT}/ports/freetype")
    message(FATAL_ERROR "The freetype overlay requires VCPKG_ROOT to point to the vcpkg installation.")
endif()

set(UPSTREAM_PORT_DIR "$ENV{VCPKG_ROOT}/ports/freetype")

if("subpixel-rendering" IN_LIST FEATURES)
    set(SUBPIXEL_RENDERING_PATCH "${UPSTREAM_PORT_DIR}/subpixel-rendering.patch")
endif()

# GitLab archive downloads are protected by Anubis on this network.  Retrieve the
# dereferenced upstream release tag through Git, preserving the exact source
# revision and vcpkg's normal patch set.
vcpkg_from_git(
    OUT_SOURCE_PATH SOURCE_PATH
    URL "https://gitlab.freedesktop.org/freetype/freetype.git"
    REF 0a0221a1347e2f1e07c395263540026e9a0aa7c7
    HEAD_REF master
    PATCHES
        "${UPSTREAM_PORT_DIR}/0003-Fix-UWP.patch"
        "${UPSTREAM_PORT_DIR}/brotli-static.patch"
        "${UPSTREAM_PORT_DIR}/bzip2.patch"
        "${UPSTREAM_PORT_DIR}/fix-exports.patch"
...
configure_file("${UPSTREAM_PORT_DIR}/vcpkg-cmake-wrapper.cmake"
