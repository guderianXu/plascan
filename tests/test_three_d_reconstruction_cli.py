...
class ThreeDReconstructionCliTest(unittest.TestCase):
    ...
    def test_cli_defaults_match_gui_three_d_reconstruction_workflow(self):
        ...
        self.assertIn("--mvs-fusion-confidence", source)
        self.assertIn("double mvsFusionConfidence = 0.50", source)
        self.assertIn("denseSettings.fusionMinConfidence = mvsFusionConfidence", source)
